...
Это файл уже более "молодой" темы "Кастомизации под клиента" но имя файла (что важно!) совпадает, тоже App.js:
...
- [Вот наши доки](https://docs.mosaic.js.org/), они вечно в процессе, извините!
- [Cам репозиторий](https://github.com/tilework/mosaic)
- [ScandiPWA, наша витрина для онлайн-коммерции](https://github.com/scandipwa/scandipwa) — если интересно, с чего всё начиналось.
- [Пример проекта написанного модульно с mosaic](https://github.com/scandipwa/shopify)
