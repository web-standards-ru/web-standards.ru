...
{% responsiveImage "./src/articles/coder-vs-designer/images/layers.jpg", "Слои в Фотошопе." %}
...
{% responsiveImage "./src/articles/coder-vs-designer/images/guides.jpg", "Направляющие в Фотошопе." %}
...
{% responsiveImage "./src/articles/coder-vs-designer/images/stickers.jpg", "Липкие листочки в Фотошопе." %}
...
{% responsiveImage "./src/articles/coder-vs-designer/images/fish.jpg", "Рыба — произвольный текст, который вписывается в контентные блоки." %}
...
{% responsiveImage "./src/articles/coder-vs-designer/images/details.jpg", "Типовые элементы на макете." %}
