...
Когда речь заходит о сетках, мир фронтенда делится на два лагеря. Один пишет сеточные классы в разметке (например, такой подход используют Bootstrap и Foundation). Я называю это _HTML-сетками._ Разметка выглядит так:
...
<figure>
    {% responsiveImage "./src/articles/responsive-grid-system/images/1.jpg", "Свойство box-sizing и его влияние на расчёт ширины." %}
...
<figure>
    {% responsiveImage "./src/articles/responsive-grid-system/images/2.png", "Трёхколоночная сетка без отступов." %}
...
<figure>
    {% responsiveImage "./src/articles/responsive-grid-system/images/5.png", "Схлопывание флоата." %}
...
<figure>
    {% responsiveImage "./src/articles/responsive-grid-system/images/6.png", "Четыре возможных способа создать колонки и отступы." %}
...
<figure>
    {% responsiveImage "./src/articles/responsive-grid-system/images/7.png", "Внешние односторонние отступы." %}
...
<figure>
    {% responsiveImage "./src/articles/responsive-grid-system/images/8.png", "Ошибка субпикселного округления может сломать сетку, вытолкнув последний элемент на следующую строку." %}
...
<figure>
    {% responsiveImage "./src/articles/responsive-grid-system/images/9.png", "Код не справляется, если строк больше, чем одна." %}
...
<figure>
    {% responsiveImage "./src/articles/responsive-grid-system/images/10.png", "Односторонние отступы с использованием внутренних отступов." %}
...
<figure>
    {% responsiveImage "./src/articles/responsive-grid-system/images/11.png", "Разделение внешних отступов." %}
...
<figure>
    {% responsiveImage "./src/articles/responsive-grid-system/images/12.png", "Внутренние разделённые отступы." %}
...
<figure>
    {% responsiveImage "./src/articles/responsive-grid-system/images/13.jpg", "Фон отображается на padding." %}
...
<figure>
    {% responsiveImage "./src/articles/responsive-grid-system/images/14.png", "Пример сетки для раскладки, которая используется только для гостевых статей." %}
...
<figure>
    {% responsiveImage "./src/articles/responsive-grid-system/images/15.png", "" %}
</figure>
