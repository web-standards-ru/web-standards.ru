...
- [Web Accessibility Laws & Policies](https://www.w3.org/WAI/policies/), W3C WAI. Краткая информация о законах некоторых стран, которые регулируют доступность.
...
- [The effect of CSS on screen readers](https://uselessdivs.com/blog/the-effect-of-css-on-screen-readers). Пост из блога Use Less Div. Это дополнение к посту Бена Майерса. Проверка того, изменилась ли в 2021 году ситуация с CSS и доступностью.
