...
{% responsiveImage "./src/articles/mobile-a11y/images/2.jpg", "" %}
...
{% responsiveImage "./src/articles/mobile-a11y/images/3.jpg", "" %}
...
<figure>
    {% responsiveImage "./src/articles/mobile-a11y/images/4.png", "Лента Твиттера в покое." %}
    {% responsiveImage "./src/articles/mobile-a11y/images/5.png", "Лента Твиттера потянута вниз." %}
    {% responsiveImage "./src/articles/mobile-a11y/images/6.png", "Появление спиннера вверху ленты." %}
...
{% responsiveImage "./src/articles/mobile-a11y/images/7.png", "" %}
