...
<figure>
    {% responsiveImage "./src/articles/top-themes-and-frameworks/image/1.png", "Поисковые запросы по фреймворкам: январь 2014 — декабрь 2018." %}
</figure>
...
<figure>
    {% responsiveImage "./src/articles/top-themes-and-frameworks/image/2.png", "Поисковые запросы по фреймворкам: январь 2014 — декабрь 2017." %}
</figure>
...
<figure>
    {% responsiveImage "./src/articles/top-themes-and-frameworks/image/3.png", "React, количество скачиваний в месяц: 2014–2018." %}
</figure>

**Angular, количество скачиваний в месяц: 2014–2018**

<figure>
    {% responsiveImage "./src/articles/top-themes-and-frameworks/image/4.png", "Angular, количество скачиваний в месяц: 2014–2018." %}
</figure>

**Vue.js, количество скачиваний в месяц: 2014–2018**

<figure>
    {% responsiveImage "./src/articles/top-themes-and-frameworks/image/5.png", "Vue.js, количество скачиваний в месяц: 2014–2018." %}
</figure>

**Визуализация по всем трём одновременно:**

<figure>
    {% responsiveImage "./src/articles/top-themes-and-frameworks/image/6.png", "Визуализация по всем трём одновременно." %}
</figure>
...
Примите за доказательство приведенные выше графики скачиваний. В одном 2018 их было больше, чем за все прошлые годы _вместе взятые._
...
<figure>
    {% responsiveImage "./src/articles/top-themes-and-frameworks/image/7.png", "Вакансии для фреймворков, декабрь 2018." %}
...
<figure>
    {% responsiveImage "./src/articles/top-themes-and-frameworks/image/8.png", "Графейнный график." %}
</figure>
...
<figure>
    {% responsiveImage "./src/articles/top-themes-and-frameworks/image/9.png", "Точки десятикратного роста Биткоина." %}
</figure>
...
<figure>
    {% responsiveImage "./src/articles/top-themes-and-frameworks/image/10.png", "График появления нового ICO." %}
</figure>
