...
{% responsiveImage "./src/articles/introduction-to-variable-fonts/images/wakamaifondue.png", "" %}
...
{% responsiveImage "./src/articles/introduction-to-variable-fonts/images/devtools-fonts.png", "" %}
