...
Человеческий глаз способен различить гораздо больше цветов, чем способны отображать многие устройства. Текущий, стандартно поддерживаемый набор цветов называется sRGB.
