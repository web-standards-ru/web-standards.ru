...
Человеческий глаз способен различить гораздо больше цветов, чем способны отображать многие устройства. Текущий набор цветов, который стандартно поддерживается мониторами, называется sRGB.
