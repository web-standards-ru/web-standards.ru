...
{% responsiveImage "./src/articles/menu-buttons/images/menu-navigation.png", "" %}
...
{% responsiveImage "./src/articles/menu-buttons/images/menu-expanded.png", "" %}
...
{% responsiveImage "./src/articles/menu-buttons/images/menu-wikipedia.png", "" %}
...
{% responsiveImage "./src/articles/menu-buttons/images/tree.png", "" %}
...
{% responsiveImage "./src/articles/menu-buttons/images/phone.png", "" %}
...
<figure>
    {% responsiveImage "./src/articles/menu-buttons/images/menu-selected.png", "" %}
    <figcaption>
...
{% responsiveImage "./src/articles/menu-buttons/images/menu-focused.png", "" %}
