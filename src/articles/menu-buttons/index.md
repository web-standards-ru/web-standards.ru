...
1. Ссылка верхнего уровня должна быть _ссылкой_. То есть она не ведёт себя как кнопка меню.
...
Добавление `tabindex="-1"` к пунктам меню делает их недоступными для фокуса с помощью Tab, но сохраняет возможность фокуса на элементах при нажатии на клавиши со стрелками.
    ...
    <div role="menu">
      ...
      <button role="menuitem" tabindex="-1">Очень высокая</button> </div>
...
Но это _возможно_ имитировать с помощью `aria-expanded`. Нам просто нужно добавить наш лейбл к двум элементам со `<span>`, как показано ниже.
    ...
    <input type="checkbox" role="button"
           aria-haspopup="true" id="toggle" class="vh">
...
<iframe src="https://medium.com/media/03d2ec33ba6feba09a1a7971cb794343" frameborder=0></iframe>
...
![](images/menu-selected.png)
_Когда пользователь выбирает пункт, меню закрывается и фокус перемещается на кнопку меню. Для пользователей важно возвращаться к такому элементу после закрытия меню._
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/Aw_HMHdId88" frameborder="0" allowfullscreen></iframe>
