...
button.addEventListener('click', (evt) => {
    ...
    // не допускаем появления клавиатуры на мобильных девайсвх
...
Важная особенность чтения из буфера состоит в том, что оно работает не напрямую. Например, в Google Chrome во время попытки прочитать данные из буфера пользователя уведомят о попытке чтения и предложат разрешить или запретить действие. А Safari, например, покажет контекстное меню с пунктом «Paste».
...
<figure>
    <img src="images/safari-context-menu.png" alt="Контекстное меню в Safari">
    <figcaption>
        Контектсное меню отображаемое Safari при попытке вставки из буфера обмена
    </figcaption>
</figure>
