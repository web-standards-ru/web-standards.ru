...
tags:
    ...
    - html
    - a11y
preview: 'Слайдеры не так ужасны, но у нас сложилась культура делать их плохо. Обычно во всём виноваты конкретные реализации, а не концепция сама по себе. Как и со многими инклюзивными вещами, правильное решение заключается не в том, что именно вы делаете, а в том, чего не делаете в композиции компонента. Итак, мы создадим то, что позволит перемещать контент вдоль горизонтальной оси.'
hero:
...
<figure>
    {% responsiveImage "./src/articles/a-content-slider/images/carousel.png", "Пример карусели." %}
    <figcaption>
...
{% responsiveImage "./src/articles/a-content-slider/images/horizontal-scroll.png", "Горизонтальный скролл слайдера." %}
...
{% responsiveImage "./src/articles/a-content-slider/images/scroll-instructions.png", "Инструкция в поле слайдера." %}
...
<figure>
    {% responsiveImage "./src/articles/a-content-slider/images/focus-container.png", "Движение фокуса по элементам скролла." %}
    <figcaption>
...
{% responsiveImage "./src/articles/a-content-slider/images/container-size.png", "Размеры контейнера с текстом подписи." %}
...
{% responsiveImage "./src/articles/a-content-slider/images/loaded-slide.png", "Порядок загрузки изображений слайдера." %}
...
{% responsiveImage "./src/articles/a-content-slider/images/two-visible-slides.png", "Класс 'visible' на даух слайдах при прокрутке." %}
...
{% responsiveImage "./src/articles/a-content-slider/images/image-preloader.png", "Индикатор загрузки для слайда." %}
...
{% responsiveImage "./src/articles/a-content-slider/images/focus-on-initial-state.png", "Положение фокуса при прокрутке слайдера." %}
...
<figure>
    {% responsiveImage "./src/articles/a-content-slider/images/disable-focus-for-out-of-viewport-slides.png", "Фокус на двух слайдах в поле видимости." %}
    <figcaption>
