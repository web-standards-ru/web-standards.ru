...
<figure>
    {% responsiveImage "./src/articles/desktop-app/images/1.jpg", "" %}
    <figcaption>
...
{% responsiveImage "./src/articles/desktop-app/images/2.jpg", "" %}
...
<figure>
    {% responsiveImage "./src/articles/desktop-app/images/3.png", "Архитектура Electron, показывающая главный процесс и процессы отрисовки. Названия файлов могут быть другими." %}
    <figcaption>
...
{% responsiveImage "./src/articles/desktop-app/images/4.png", "" %}
