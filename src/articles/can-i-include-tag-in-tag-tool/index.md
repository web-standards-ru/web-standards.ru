...
4) Далее производится проверка на пересечение множеств и:
    _ если найдены общие ключевые слова - то `положительный вердикт` о возможности включения тега в тег
    _ если нет пересекающихся ключевых слов - то `отрицательный вердикт` о возможности включения тега в тег
