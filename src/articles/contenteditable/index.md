...
Попробуйте отредактировать CSS, приведённый ниже:
...
Должен отметить, что появлением и отличной поддержкой атрибута мы обязаны IE 5.5, хотя на самом деле ранний вариант `contenteditable` был [разработан и внедрён Microsoft в июле 2000 года](http://msdn.microsoft.com/en-us/library/ms537837(VS.85).aspx).
...
<blockquote>
    ...
    <p>Простой пример можно увидеть тут: <a href="https://jsbin.com/owavu3">Сохранение данных из элемента с <code>contenteditable</code> при помощи AJAX</a>.</p>
    <footer>
