...
![](images/5.png)
_Первая отрисовка сайта [MSN](https://www.msn.com/)._
...
_Упрощённый графический слой._
...
_Первая отрисовка и первая полезная отрисовка._
...
_Первая отрисовка, первая отрисовка контента, первая значимая отрисовка._
