...
2. **Вторая часть** посвящена практическим примерам, которые могут быть полезны веб-разработчикам.
3. **Третья часть** содержит интересности для организации процесса разработки.

_Вторая и третья части выйдут 9 и 10 февраля, соответственно — прим. редактора._
...
Кажется, теперь мы прошлись по всему самому необходимому и готовы попробовать использовать технологию на практике. Продолжение завтра во второй части.
