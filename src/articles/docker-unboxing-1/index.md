...
1. В первой части описывается терминология и основные инструменты Docker — _вы находитесь здесь._
...
Кажется, теперь мы прошлись по всему самому необходимому и готовы попробовать использовать технологию на практике. Добро пожаловать [во вторую часть](/articles/docker-unboxing-2).
