...
<figure>
    {% responsiveImage "./src/articles/the-cost-of-javascript/images/1.png", "" %}
</figure>
...
<figure>
    {% responsiveImage "./src/articles/the-cost-of-javascript/images/2.png", "" %}
</figure>
...
<figure>
    {% responsiveImage "./src/articles/the-cost-of-javascript/images/3.png", "" %}
</figure>

Вкладки Bottom-Up и Call Tree позволят оценить время, затраченное на эти задачи:

<figure>
    {% responsiveImage "./src/articles/the-cost-of-javascript/images/4.png", "Панель Performance в Chrome DevTools: Bottom-Up." %}
...
<figure>
    {% responsiveImage "./src/articles/the-cost-of-javascript/images/5.png", "" %}
</figure>
...
<figure>
    {% responsiveImage "./src/articles/the-cost-of-javascript/images/6.png", "" %}
</figure>
...
<figure>
    {% responsiveImage "./src/articles/the-cost-of-javascript/images/7.png", "170 КБ сжатого JS против байтов JPEG на Moto G4 в медленной сети." %}
...
<figure>
    {% responsiveImage "./src/articles/the-cost-of-javascript/images/8.png", "Время парсинга для 1Мб JS бандла (≈250KB gzip) на настольных и мобильных устройствах различных классов." %}
...
<figure>
    {% responsiveImage "./src/articles/the-cost-of-javascript/images/9.png", "Сравнение производительности чипа A11 Bionic и Snapdragon 617." %}
...
<figure>
    {% responsiveImage "./src/articles/the-cost-of-javascript/images/10.png", "" %}
</figure>
...
<figure>
    {% responsiveImage "./src/articles/the-cost-of-javascript/images/11.png", "" %}
</figure>
...
<figure>
    {% responsiveImage "./src/articles/the-cost-of-javascript/images/12.png", "" %}
</figure>
...
<figure>
    {% responsiveImage "./src/articles/the-cost-of-javascript/images/13.png", "" %}
</figure>
...
<figure>
    {% responsiveImage "./src/articles/the-cost-of-javascript/images/14.png", "" %}
</figure>
...
<figure>
    {% responsiveImage "./src/articles/the-cost-of-javascript/images/15.png", "Progressive Bootstrapping." %}
    <figcaption>
...
<figure>
    {% responsiveImage "./src/articles/the-cost-of-javascript/images/16.png", "Полезно посмотреть, какой объём выделяется для логики приложения." %}
