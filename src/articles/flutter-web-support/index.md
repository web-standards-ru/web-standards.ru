...
tags:
    - article
    - css
preview: 'Продакт-менеджер Google Марьям Асмани рассказывает о возможностях Flutter для веба, который теперь можно использовать как цель для сборки в стабильной ветке фреймворка.'
---
...
![iRobot Education разработало приложение iRobot Coding, которое использует Flutter, доступно в вебе, чтобы каждый мог поучится программировать](images/1.png)
...
![Архитектура для поддержки Flutter в вебе](images/2.png)
...
![Возможности Flutter для веб-платформы, доступные в стабильной ветке](images/3.png)
...
![Rive, инструмент для создания пользовательских анимаций, перестроил свое приложение с помощью Flutter в Интернете, и теперь оно доступно в бета-версии.](images/4.png)
...
![Демо-версия Flutter Plasma, созданная Феликсом Блашке и работающая в Safari, Firefox, Edge и Chrome.](images/5.png)
...
![Демонстрационная страница Flutter Plasma demo - это пример плагина url_strategy, основанного на пользовательских URL-стратегиях Flutter, в действии.](images/6.png)
...
![Invoice Ninja, приложение для управления счетами, запустило приложение PWA, используя ту же кодовую базу, что и существующие мобильные приложения Flutter.](images/7.png)
...
![Решение по управлению недвижимостью для Zurich Insurance, созданное компанией Spica Technologies, является отличным примером веб-поддержки бизнес-приложений Flutter, которую можно включить в настольных браузерах.](images/8.png)
...
![Moi Mobiili, современный оператор мобильной виртуальной сети, недавно запустил свое веб-приложение с помощью Flutter.](images/9.png)
...
![Simplebet использовала веб-поддержку Flutter для создания высокоинтерактивных встраиваемых ставок на НФЛ и НБА в рамках существующего набора мобильных приложений Fanduel.](images/10.png)
