...
<figure>
    {% responsiveImage "./src/articles/big-screens/images/great-discontent.jpg", "Сайт The Great Discontent. Главная страница с большой фотографией и текстом, который написан большими буквами." %}
    <figcaption>The Great Discontent использует большие картинки в начале каждой статьи.</figcaption>
</figure>

<figure>
    {% responsiveImage "./src/articles/big-screens/images/roger-ebert.jpg", "Страница обзора фильма Пятая власть с сайта Роджера Эберта. Перед текстом обзора — кадр из фильма. Внизу фотографии название фильма. Слева расположено боковое меню со списком актёров." %}
...
<figure>
    {% responsiveImage "./src/articles/big-screens/images/medium.jpg", "Статья с сайта Medium, которая называется Креативные люди говорят нет. В начале статьи изображение с надписью Нет. Слева от текста комментарии пользователей к нему." %}
...
<figure>
    {% responsiveImage "./src/articles/big-screens/images/manchester.jpg", "Страница сайта Manchester City Council. Сверху меню со списком ссылок и поисковой строкой. В основной части список сервисов с иконками. Снизу слайдер." %}
    <figcaption>Сайт Manchester City Council и разделение содержимого на части.</figcaption>
</figure>

<figure>
    {% responsiveImage "./src/articles/big-screens/images/juliana.jpg", "Главная страница сайта Juliana Bicycles. На ней слайдер и галерея с фотографиями велосипедов и их названиями." %}
...
<figure>
    {% responsiveImage "./src/articles/big-screens/images/google-images.jpg", "Выдача Google Images по запросу Отзывчивость. В ней фотографии разных устройств: планшетов, ноутбуков, телефонов." %}
...
<figure>
    {% responsiveImage "./src/articles/big-screens/images/pinterest.jpg", "Страница сайта Pinterest с галереей пинов по запросу Колоссальный." %}
...
<figure>
    {% responsiveImage "./src/articles/big-screens/images/uniqlo.jpg", "Страница сайта Uniqlo с каталогом коллекции зимней одежды. На фотографиях жилеты, пуховики, куртки и мужчины в них." %}
...
<figure>
    {% responsiveImage "./src/articles/big-screens/images/choiseul.jpg", "Страница французского сайта Института международной политики и геоэкономики. Сетка, состоящая из блоков разных цветов с текстами и ссылками в виде стрелок внутри. Сверху и слева меню." %}
