...
![Возможность делать скриншот элемента интерфейса пользователя с подсветкой узла DOM-дерева, участвующего в сдвиге раскладки на странице.](images/1.png)
...
![Метрики производительности Lighthouse.](images/2.png)
...
![Элемент, отрисовка которого занимает наибольшее время (LCP-элемент).](images/4.png)
...
![Аудит размера картинок.](images/5.png)
...
![Подсвеченный LCP-элемент.](images/6.png)
...
![Предварительная загрузка картинок.](images/7.png)
...
![Оценка Cumulative Layout Shift в Lighthouse выделяет узел DOM-дерева, который даёт существенный вклад в индикатор CLS.](images/8.png)
...
![Клик по скриншоту элемента увеличивает его.](images/9.png)
...
![Генератор сдвига раскладки страницы, с выделением процесса сдвига.](images/10.gif)
...
![Google Search Console отображает страницы, на которых есть проблемы с CLS.](images/11.png)
...
![Поиск картинок без ширины и высоты.](images/12.png)
...
![Аудит рекламных баннеров на странице, которые влияют на сдвиг раскладки и увеличивают время готовности к взаимодействию с пользователем.](images/13.png)
...
![Отчёт об анимациях, не объединённых в общий слой.](images/14.png)
...
![Отчёт о долгих JS-тасках в основном потоке.](images/15.png)
...
![JS-таски в основном потоке, отображённые с помощью Calibre.](images/16.png)
...
![Блокировка сетевых запросов.](images/17.png)
...
![Заблокировать запрашиваемый URL в инструментах разработчика.](images/18.png)
...
![После блокировки дорогого сетевого запроса.](images/19.png)
...
![Отчёт позволяет выделить виджеты, которые могут быть заменены на заглушку с ленивой загрузкой.](images/20.png)
...
![Увеличение скорости загрузки страницы с помощью ленивой загрузки сторонних скриптов.](images/21.png)
