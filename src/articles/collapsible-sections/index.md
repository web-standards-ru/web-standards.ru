...
{% responsiveImage "./src/articles/collapsible-sections/images/headers-to-collapsible.png", "Слева - развернутые секции с заголовками следующие друг за другом. Справа - все секции свернуты. Друг за другом следуют только заголовки." %}
...
{% responsiveImage "./src/articles/collapsible-sections/images/button-in-header.png", "Кнопка 'Мой раздел' внутри заголовка второго уровня." %}
...
{% responsiveImage "./src/articles/collapsible-sections/images/collapsed-and-epxpanded-section.png", "Две сворачиваемые секции. Сверху кнопка в заголовке свернута, снизу - развернута." %}
...
{% responsiveImage "./src/articles/collapsible-sections/images/component-structure.png", "Структура компонента. Шаблон компонента связан с Shadow DOM, статический контент - с Light DOM." %}
...
{% responsiveImage "./src/articles/collapsible-sections/images/component-warning-example.png", "Предупреждение в консоли, которое рекомендует использовать заголовок в качестве предпочтительного элемента." %}
...
{% responsiveImage "./src/articles/collapsible-sections/images/expand-and-collapse-all.png", "Над двумя сворачиваемыми секциями находятся контролы: свернуть все, развернуть все." %}
