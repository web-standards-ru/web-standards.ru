...
{% responsiveImage "./src/articles/a11y-poll-2019/images/health-restrictions.png", "Диаграмма нарушения здоровья участников опроса." %}
...
{% responsiveImage "./src/articles/a11y-poll-2019/images/user-level.png", "Диаграмма с уровнем владения техникой участников опроса." %}
...
{% responsiveImage "./src/articles/a11y-poll-2019/images/device-usage-statistics-by-type.png", "Диаграмма с данными о том, какой техникой чаще всего пользуются участники опроса." %}
...
{% responsiveImage "./src/articles/a11y-poll-2019/images/percent-of-usage-assistive-technology.png", "Диаграмма с процентным соотношением пользователей, которые пользуются вспомогательными технологиями." %}
...
{% responsiveImage "./src/articles/a11y-poll-2019/images/assistive-technology-list.png", "Вспомогательные технологии, которыми пользуются участники опроса." %}
...
{% responsiveImage "./src/articles/a11y-poll-2019/images/way-to-learn-assistive-technology.png", "Диаграмма с процентным соотношением того, как пользователи научились пользоваться вспомогательными технологиями." %}
...
{% responsiveImage "./src/articles/a11y-poll-2019/images/frequency-inaccessible-sites.png", "Диаграмма, которая показывает как часто пользователи сталкиваются с недоступными сайтами." %}
...
{% responsiveImage "./src/articles/a11y-poll-2019/images/inaccessible-sites-parts.png", "Диаграмма с недоступными элементами на сайтах по мнению участников опроса." %}
...
{% responsiveImage "./src/articles/a11y-poll-2019/images/accessible-sites.png", "Диаграмма с доступными сайтами по мнению участников опроса." %}
...
{% responsiveImage "./src/articles/a11y-poll-2019/images/inaccessible-sites-list.png", "Диаграмма с недоступными сайтами." %}
