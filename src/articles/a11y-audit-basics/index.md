...
- [Определение](#section-)
- [Зачем проводить](#section-2)
- [Принципы и источники критериев](#section-3)
- [Когда и как часто проводить](#section-4)
- [Типы аудита](#section-5)
- [Методологии](#section-15)
- [Публичные заявления, VPAT и ACR](#section-22)
- [Оценка доступности пользователями](#section-25)
- [Что делать после аудита](#section-28)
- [Выводы](#section-29)
- [Полезные ссылки](#section-30)
...
- Принятие решения об изменениях в интерфейсе. Например, когда разрабатываете новую функцию.
...
Заполняет пробелы автоматического. Можно проверить интерфейс с клавиатуры, посмотреть страницу с экранной лупой, провести юзабилити-тестирование или интервью с пользователями.
