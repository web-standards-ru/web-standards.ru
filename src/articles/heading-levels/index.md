...
tags:
    ...
    - html
    - a11y
preview: 'Спецификация HTML описывает шесть видов заголовков. WebAIM провела опрос пользователей скринридеров, и он показал, что навигация по заголовкам — это самый важный способ навигации для людей, которые пользуются вспомогательными технологиями для поиска информации. Именно поэтому так важно правильно организовать заголовки на вашем сайте.'
hero:
    src: images/1.jpg
    contain: true
...
<figure>
    {% responsiveImage "./src/articles/heading-levels/images/2.jpg", "" %}
    <figcaption>
...
{% responsiveImage "./src/articles/heading-levels/images/3.png", "Сгенерированный список заголовков на странице Wikipedia" %}
...
{% responsiveImage "./src/articles/heading-levels/images/4.png", "Результат поиска в Bing" %}
