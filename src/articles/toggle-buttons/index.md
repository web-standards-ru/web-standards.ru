...
tags:
    ...
    - css
    - a11y
preview: 'В этой статье я объясню, как сделать переключатели инклюзивными. Нет единого способа решения этой проблемы, как и в случае любого другого компонента, особенно когда подобные контролы рассматриваются в разных контекстах. Многое можно испортить или просто забыть сделать, так что попробуем этого избежать.'
hero:
...
{% responsiveImage "./src/articles/toggle-buttons/images/notify.png", "" %}
...
{% responsiveImage "./src/articles/toggle-buttons/images/radio.png", "" %}
...
{% responsiveImage "./src/articles/toggle-buttons/images/notification.png", "" %}
...
<figure>
    {% responsiveImage "./src/articles/toggle-buttons/images/controls.png", "" %}
    <figcaption>
...
<figure>
    {% responsiveImage "./src/articles/toggle-buttons/images/play-and-pause.png", "" %}
    <figcaption>
...
{% responsiveImage "./src/articles/toggle-buttons/images/notify2.png", "" %}
