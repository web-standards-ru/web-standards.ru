...
Во [второй части](https://web-standards.ru/articles/docker-unboxing-2) были рассмотрены практические примеры упаковки приложений. В заключительной части мы рассмотрим способы использования Docker в процессе самой разработки.

Навиция по третьей части:
