...
**Обновление от 6 ноября 2019:** Вот [подробная статья](https://css-tricks.com/can-you-view-print-stylesheets-applied-directly-in-the-browser/) Криса Койера о том, как эмулировать печатные стили в 2019 году.

Для отладки печатных стилей в Firefox откройте _Developer Toolbar_ (<kbd>Shift F2</kbd> или Tools > Web Developer > Developer Toolbar) и введите _media emulate print_ в поле внизу окна браузера и нажмите <kbd>Enter</kbd>. Активная вкладка будет вести себя так, как будто для неё задан медиа-тип `print`, пока вы не закроете её или не обновите страницу.
...
Если вы пишете свои медиавыражения так, как в примере ниже, имейте в виду, что CSS-правила в этом случае не будут применяться к печатным стилям.
