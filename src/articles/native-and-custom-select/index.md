...
<figure>
    <img src="images/1.png" alt="Сравнение кастомного и нативного селектов: слева кастомный в стиле сайта, справа нативный в стиле ОС.">
...
<figure>
    <img src="images/2.jpg" src="Кадр из мультфильма «Спасти Немо»: огромная зубастая акула за спиной двух крошечных испуганных рыбок.">
...
<figure>
    <img src="images/3.png" alt="Схема с примерами выпадающих списков: 1. Селект, 2. Меню, 3. Меню или селект, 4. Открывающаяся навигация, 5. Что-то другое.">
...
<figure>
    <img src="images/4.png" alt="Три выпадающих селекта: кастомная сортировка товаров, кастомный выбор отображения списка, нативная сортировка товаров.">
...
**P.S.** Не забудьте [использовать название](https://adrianroselli.com/2020/03/stop-using-drop-down.html) при создании выпадающего списка 😉
